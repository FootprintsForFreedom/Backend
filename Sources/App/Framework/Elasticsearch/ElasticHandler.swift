...
public struct ElasticHandler {
    ...
    func bulk(_ operations: [ESBulkOperation<some ElasticModelInterface, some Hashable>]) async throws -> ESBulkResponse {
    ...
    func get<Document: Decodable>(document documentType: Document.Type = Document.self, id: some Hashable, from indexName: String) async throws -> ESGetSingleDocumentResponse<Document> {
