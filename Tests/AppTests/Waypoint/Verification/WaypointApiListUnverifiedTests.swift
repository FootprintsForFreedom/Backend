    ...
    func testSuccessfulListRepositoriesWithUnverifiedModels() async throws {
        ...
        try app
            ...
            .expect(AppApi.Page<Waypoint.Detail.List>.self) { content in
                ...
                XCTAssertEqual(content.items.map(\.id).uniqued().count, unverifiedWaypointCount)
    ...
    func testSuccessfulListUnverifiedWaypointsForRepository() async throws {
        ...
        try app
            ...
            .expect(AppApi.Page<Waypoint.Repository.ListUnverifiedWaypoints>.self) { content in
                ...
                XCTAssertEqual(content.items.map(\.detailId).uniqued().count, unverifiedWaypointForRepositoryCount)
    ...
    func testSuccessfulListUnverifiedLocationsForRepository() async throws {
        ...
        try app
            ...
            .expect(AppApi.Page<Waypoint.Repository.ListUnverifiedLocations>.self) { content in
                ...
                XCTAssertEqual(content.items.map(\.locationId).uniqued().count, unverifiedLocationForRepositoryCount)
                XCTAssertEqual(content.items.map(\.locationId).uniqued().count, content.items.count)
